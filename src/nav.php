                    ...
                    <div class="dropdown-menu">
                        <form class="px-4 py-3" action="" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" name="nickname" class="form-control" id="nickname" placeholder="Nickname" value="<?php if (isset($_COOKIE["member_nickname"])) {
                                                                                                                                        echo $_COOKIE["member_nickname"];
                                                                                                                                    } ?>">
                            </div>
                            <div class="form-group">
                                <label for="exampleDropdownFormPassword1">Password</label>
                                <input type="password" name="pwd" class="form-control" id="exampleDropdownFormPassword1" placeholder="Password" value="<?php if (isset($_COOKIE["member_password"])) {
