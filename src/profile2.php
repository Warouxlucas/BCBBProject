...
if(isset($_POST['submit']))
{
  ...
  $pdoQuery = "UPDATE users SET pwd='$password',firstname='$firstname', lastname='$lastname',nickname= '$nickname' ,gender='$gender' ,signature='$signature', birthday='$birthdate' WHERE users_id='$userid' "; //il faut générer avec le $session le numero d'id
