...
<div class="container">
        ...
        '<button class="btn btn-secondary dropdown-toggle" type="button" id="'.$boardsname.'" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">'.$boardsname.'</button>'.
        '<div class="dropdown-menu" aria-labelledby="'.$boardsname.'">';
        $i=0;
                                        ...
                                        echo '<a class="dropdown-item" href="#">See more...</a>'.'</div></div>';
                                }
?>
        </div>
        </div>
